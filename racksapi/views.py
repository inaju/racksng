...
def send_btc_again(request):
    ...
    # print(type(float(0.00000001)))
    # print(type(float(data["amount"])))
    # print(type(racks_user.btc_balance))
    print(type(int(0.00000001)))
    print(type(int(data["amount"])))
    racks_user.btc_balance -= 0.00000001 * float(data["amount"])
